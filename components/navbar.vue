    ...
    <div class="lg:flex lg:float-left">
        ...
        md:translate-x-0 transition duration-100 ease-in-out z-10">
            ...
            <div class="mt-10 mb-10">
                ...
                <NuxtLink to="/myprograms"><li class="my-1 mx-2 p-3 flex"><Icon name="lucide:briefcase" size="1.5em" class="mr-3"/>Programs</li></NuxtLink>
                <NuxtLink to=""><li class="my-1 mx-2 p-3 flex"><Icon name="material-symbols:menu-book-outline-rounded" size="1.5em" class="mr-3"/>Resources</li></NuxtLink>
            ...
            <div class="mt-10">
                ...
                <NuxtLink to="/login"><li class="my-1 mx-2 p-3">Log out</li></NuxtLink>
                </ul>
            </div>
        </nav>  
